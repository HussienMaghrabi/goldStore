                                  ...
                                  <td>{{ $item->name }}</td>
                                   ...
                                   <td>{{ $item->phone }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#danger_{{$item->id}}"><i class="fa fa-fw fa-trash text-red"></i></a>
                                        <a href="{{ route($resource['route'].'.block', [App::getLocale(), $item->id]) }}">{{$item->status == 2 ? __('dashboard.Unblock') : __('dashboard.Block')}}</a>
                                    </td>
